...
class _AddSaleState extends State<AddSale> {
  ...
  late Item _itemObj;
  var _addItemPossible = false;
  final _formKey = GlobalKey<FormState>();
  Bill argObject =
      Bill(billNo: "", paymentType: "", accName: "", billDate: "", dueDate: "");
  ...
  void getItemByName(String item) {
    setState(() {
      ...
      if (int.parse(_itemObj.quantity) > 0) {
        _addItemPossible = true;
      } else {
        _addItemPossible = false;
      }
    });
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: OutlinedButton(
                          onPressed: _addItemPossible == false
                              ? null
                              : () {
